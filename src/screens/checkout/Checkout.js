...
class Checkout extends Component {
   ...
   */
  incrementActiveStep = () => {
    if (this.state.activeStep === 0 && this.state.selected === undefined) {
                        ...
                        (this.state.addresses || []).map((address, index) => (
                          <GridListTile key={address.id}
                            ...
                            <Grid container>
                              ...
                              <Grid item xs={2}>
                                <IconButton className="selectAddresscircle" aria-label="Select Address" onClick={() => this.onAddressClick(address)}>
                                  {address.id === this.state.selected ? <CheckCircle style={{ color: "green" }} /> : <CheckCircle style={{ color: "#999999" }} />}
                                </IconButton>
                              </Grid>
                            </Grid>
                          </GridListTile>
