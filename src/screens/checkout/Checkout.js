...
import { StepLabel, Stepper, Step, StepContent, AppBar, Tabs, Tab, Typography, GridList, Grid, IconButton, GridListTile, FormControl, InputLabel, Input, Select, MenuItem, Button, FormLabel, RadioGroup, FormControlLabel, Radio, Card, CardContent, Snackbar } from "@material-ui/core";
    ...
    return <Fragment>
        ...
        <div className='summary-section'>
          <Card variant='elevation' className='summary-card'>
            <CardContent>
              ...
              <Typography variant='h6' component='h3' color='textSecondary' style={{textTransform: "capitalize", marginBottom: 15}}>
      ...
      <div>
        <Snackbar anchorOrigin={{ vertical: 'bottom', horizontal: 'left' }}
          key='01' message={this.state.placeOrderMessage}
          open={this.state.placeOrderMessageOpen} onClose={this.placeOrderMessageClose}
          autoHideDuration={6000} action={
            <Fragment>
